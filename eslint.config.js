...
export default [
    {
        ...
        languageOptions: {
            ...
            sourceType: 'module',
            globals: {
                /* Browser + PWA surface actually used by this codebase. Listed
                   explicitly rather than pulled from a `globals` package so the
                   config has no dependency of its own and cannot itself become
                   a thing that fails to run. */
                window: 'readonly',
                document: 'readonly',
                navigator: 'readonly',
                location: 'readonly',
