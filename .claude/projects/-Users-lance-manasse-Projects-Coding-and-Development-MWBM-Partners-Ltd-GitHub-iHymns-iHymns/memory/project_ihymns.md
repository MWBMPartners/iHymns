...
- `api.php` — Comprehensive API (35+ endpoints: songs, auth with email login, favorites, setlists, song requests, languages, translations, user access, admin management, activity log)
