...
- [iHymns Project](project_ihymns.md) — Multiplatform Christian lyrics app, MySQL (35+ tables), 60+ API endpoints, content tiers, CCLI, v0.10.0
...
- [User Accounts](feedback_user_accounts.md) — 3 auth methods, roles, orgs, email login, groups, version access, SHA-256 hashed tokens
- [DB naming](feedback_db_naming.md) — tblCamelCase tables, CamelCase columns, AS aliases for API compat
- [PHP standards](feedback_php_standards.md) — DIRECTORY_SEPARATOR everywhere, no shortcut vars, predefined constants, strict_types
- [Hymn scrapers](project_scrapers.md) — 10 scraper files in .importers/scrapers/, 5 platforms × 2 sources, moved from iLyricsDB
