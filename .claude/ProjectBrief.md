...
Last updated: 2026-06-12 (session 3) — **Lyrics-normalisation #1235: P3 SHIPPED to alpha; the P4 cutover is IN BUILD (C1–C4 done).** Full resume map: **`.claude/sessions/2026-06-12-HANDOFF-session3.md`**; plan of record: `.claude/lyrics-normalisation-strategy.md` §11 (P4) + §12 (data-quality finding).
