...
| 📖 Help Documentation | ✅ Complete | 16 guides in `help/` + in-app help (26 public topics, 50 admin sections) |
| 🎫 GitHub Issues | 🟢 Active | Highest issue **#2106** as at 2026-09-08 — see GitHub for live open/closed counts. *(Corrected 2026-09-08: this cell said #2096, and before that #2087. Both were already several issues behind on the day they were written — #2096 was ten short, and the repo's own committed files proved it without needing the network (`.claude/apple-native-status.md` names #2100/#2101/#2103/#2105; the 2026-09-07 handoff names #2106). Treat any number here as a snapshot of one moment, not a live figure.)* |
...
- **GitHub Issues**: see GitHub for live open/closed counts and the current highest number *(corrected 2026-09-08: this line carried its own copy of the highest-issue number, reading #2087 — nineteen behind by the time it was read. The number now appears once, in the status table at the top of this file; a second copy is what let the two drift apart.)*
