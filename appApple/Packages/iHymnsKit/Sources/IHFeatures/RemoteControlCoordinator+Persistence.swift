...
// BINDING). A PURE relocation out of `RemoteControlCoordinator.swift:363-392`
...
// as it always has. The coordinator does not adopt the shared helper in
// this PR (spec §2's file table: "the coordinator MAY adopt later").
import Foundation
import IHLive
