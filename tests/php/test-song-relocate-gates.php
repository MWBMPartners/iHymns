...
/* ===================================================================== *
 *  THE RECORDING DOUBLE — now the SHARED tests/php/lib/mysqli_doubles.php
 *
 *  GateRecorderMysqli (+ its Stmt/Result companions) was born in this file
 *  (#1691); the song soft-delete suite (#1694) became its second consumer,
 *  and the modularity rule makes a second consumer an extraction, not a
 *  copy. The classes moved verbatim; the #1694-marked additions there
 *  (I_S.COLUMNS answers, tblSongs row store, transaction recording) are
 *  default-inert, so this suite's scenarios behave exactly as before.
 * ===================================================================== */
